...
import { ENV_OPTIONS, ARG_OPTIONS, WRAPPER_OPTIONS, GAMESCOPE_OPTIONS, ENGINE_PRESETS } from '../../../domain/games/ConfigCatalog.js';
import { COMPAT_RULES } from '../../../domain/games/CompatibilityRules.js';
import type { SystemBlock } from './AIProvider.js';
