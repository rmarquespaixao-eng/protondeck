...
/**
 * Roda uma sequencia de comandos sob `sudo -n` (non-interactive — falha se
 * sudoers nao permite). Emite eventos line-by-line via callback.
 * Cancela quando AbortSignal dispara.
 */
export async function runSudoSequence(
  argvList: string[][],
