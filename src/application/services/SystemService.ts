...
import type { SystemUseCase } from '../ports/in/SystemUseCase.js';
import type { SystemRunner, RunnerEvent } from '../ports/out/SystemRunner.js';
...
export class SystemService implements SystemUseCase {
