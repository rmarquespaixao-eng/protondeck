import type { SteamSearchClient, ProtonDBClient, SteamStoreClient } from '../ports/out/CheckClients.js';
import type { CheckUseCase } from '../ports/in/CheckUseCase.js';
...
export class CheckService implements CheckUseCase {
  constructor(
