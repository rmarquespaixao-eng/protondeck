import type { GameRepository, GameRow, GameListFilter } from '../ports/out/GameRepository.js';
import type { GamesUseCase } from '../ports/in/GamesUseCase.js';

export class GamesService implements GamesUseCase {
